function onWindowResize() {
    ...
    window.setTimeout(function () {
        ...
        $("#invesmentplan19").mapster("resize",e);
        $("#invesmentplan20").mapster("resize",e);
        $("#invesmentplan24").mapster("resize",e);
        $("#invesmentplan25").mapster("resize",e);
    }, resizeDelay);
}
...
// Tooltip
    ...
    const reservation = 'ffcb00'; // mieszkanie zarezerwowane
